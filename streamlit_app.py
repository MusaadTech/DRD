...
st.markdown('## Drowsiness Detection System')
...
st.markdown('### Seconds to wait before sounding alarm:')
WAIT_TIME = st.slider("", 0.0, 5.0, 1.0, 0.25)

# Lowest valid value of Eye Aspect Ratio. Ideal values [0.15, 0.2].
st.markdown('### Eye Aspect Ratio threshold:')
EAR_THRESH = st.slider("", 0.0, 0.4, 0.18, 0.01)
